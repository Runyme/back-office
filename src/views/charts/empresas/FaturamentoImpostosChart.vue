...
import { empresasFaturamentoLiquidoImpostosRequest } from '@/services/requests/empresas'

export default {
  name: 'FaturamentoImpostosoChart',
  ...
  beforeMount() {
    empresasFaturamentoLiquidoImpostosRequest(this.getEmpresa.id)
