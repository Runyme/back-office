<template>
  <div class="border-2 rounded border-primary-500 px-4 py-2 flex justify-between items-center">
    ...
    >
      ...
      <span class="text-primary-700 text-sm" v-text="anexo.nome || anexo.nome_original || anexo.caminho || anexo.arquivo" />
    </a>
    <a href="#" class="rounded-full bg-error-light transition hover:bg-error-base flex p-1 ml-4" @click.prevent="deleteAnexo" v-if="isDeletabled">
