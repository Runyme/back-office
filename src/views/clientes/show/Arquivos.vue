<template>
  <div class="bg-neutral-300 p-8 flex items-start flex-col">
    ...
    <form @submit.prevent="onInputFile" class="flex flex-col mb-8 w-full items-start" v-show="isAdding">
      ...
      <InputFile class="mb-4" text="Adicionar Arquivo" ref="fileInput"/>
      <div class="flex">
...
import {clienteAddArquivoRequest} from '@/services/requests/clientes'
...
export default {
  ...
  methods: {
    ...
    async onInputFile() {
      ...
      clienteAddArquivoRequest(this.getCliente.id, form)
        .then(() => {
